<template>
  <form @submit.prevent="handleSubmit">
    ...
    <div class="mb-4">
      ...
      <InputError class="mt-2" :message="validationErrors.phone"/>
    </div>
    ...
    <div class="mb-4">
      ...
      <InputError class="mt-2" :message="validationErrors.address"/>
    </div>
    ...
    <div class="mb-4">
      ...
      <InputError class="mt-2" :message="validationErrors.birth_date"/>
    </div>
    ...
    <div class="mb-4 relative">
      ...
      <ul v-if="dropdownOpen" class="absolute z-10 w-full border bg-white shadow-md max-h-40 overflow-y-auto" @click.stop>
  ...
  methods: {
    handleSubmit() {
      ...
      if (!this.localUser.name) {
        this.validationErrors.name = 'Имя обязательно для заполнения';
      }
    },
    toggleDropdown() {
